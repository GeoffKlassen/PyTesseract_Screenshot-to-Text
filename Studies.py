...
"""
    HappyB2.0 Aug 2024 - May 2025
"""
happyb2_baseline_survey = {CSV_FILE: 'study-3749-export-3-survey-responses-20973-2025-06-14-00-46-35.csv', #'Baseline Survey 2024, Unique IDs.csv',
...
happyb2_daily_survey_ios = {CSV_FILE: 'study-3749-export-5-survey-responses-20976-2025-06-14-01-32-36.csv',
                            URL_COLUMNS: {SCREEN_COLS: ['[2_IMG] iOS screentime'],
                                          PICKUP_COLS: ['[3_IMG] iOS unlocks'],
                                          NOTIFY_COLS: ['[4_IMG] iOS notifications']
                                         }
                            }
happyb2_daily_survey_android = {CSV_FILE: 'study-3749-export-6-survey-responses-20977-2025-06-14-02-45-44.csv',
                                URL_COLUMNS: {SCREEN_COLS: ['[2_IMG] AndroidScreentime'],
                                              PICKUP_COLS: ['[3_IMG] Android unlocks'],
                                              NOTIFY_COLS: ['[4_IMG] Android notifications']
                                             }
...
"""
    HappyB2.0 Jan-May 2025
"""
happyb2_2025_baseline_survey = {CSV_FILE: 'study-3749-export-20-survey-responses-20973-2025-05-29-22-08-09.csv',
                                URL_COLUMNS: {SCREEN_COLS: ['[24_IMG] iOS_screenshot_1_duration', '[28_IMG] Android_screenshot_1_duration'],
                                              PICKUP_COLS: ['[25_IMG] iOS_screenshot_2_unlocks', '[29_IMG] Android_screenshot_2_unlocks'],
                                              NOTIFY_COLS: ['[26_IMG] iOS_screenshot_3_notifications', '[30_IMG] Android_screenshot_3_notifications']
                                              }
                                }
happyb2_2025_daily_survey_ios = {CSV_FILE: 'study-3749-export-22-survey-responses-20976-2025-05-29-22-08-28.csv',
                                 URL_COLUMNS: {SCREEN_COLS: ['[2_IMG] iOS screentime'],
                                               PICKUP_COLS: ['[3_IMG] iOS unlocks'],
                                               NOTIFY_COLS: ['[4_IMG] iOS notifications']
                                              }
                                 }
happyb2_2025_daily_survey_android = {CSV_FILE: 'study-3749-export-23-survey-responses-20977-2025-05-29-22-08-38.csv',
                                     URL_COLUMNS: {SCREEN_COLS: ['[2_IMG] AndroidScreentime'],
                                                   PICKUP_COLS: ['[3_IMG] Android unlocks'],
                                                   NOTIFY_COLS: ['[4_IMG] Android notifications']
                                                  }
...
"""
study_happyb2_prep = {NAME: "HappyB2.0 Prep",
...
study_happyb2_0 = {NAME: "HappyB2.0",
                   DIRECTORY: f'C:\\Users\\{pc_user}\\OneDrive - University of Saskatchewan\\Grad Studies\\HappyB 2.0 2024\\R Scripts\\Input Files\\Full Date Range',
                   DEFAULT_LANGUAGE: ENG,
...
study_happyb2_0_2025 = {NAME: "HappyB2.0 2025 Mar-May",
                        DIRECTORY: f'C:\\Users\\{pc_user}\\OneDrive - University of Saskatchewan\\Grad Studies\\HappyB 2.0 2024\\R Scripts\\Input Files\\2025 Jan-May',
                        DEFAULT_LANGUAGE: ENG,
                        SURVEY_LIST: [happyb2_2025_baseline_survey, happyb2_2025_daily_survey_ios, happyb2_2025_daily_survey_android],
                        CATEGORIES: [SCREENTIME, PICKUPS, NOTIFICATIONS],
                        USER_ID_COLUMN: 'Participant ID',
                        DATE_COLUMN: 'Record Time',
                        DEVICE_ID_COLUMN: 'Device ID',
...
study_bch = {NAME: "BCH",
             ...
             DEVICE_ID_COLUMN: 'Device ID',
             MAX_APPS: 8,
             LOCAL_FOLDER: 'Individual Participant Screenshots'}

studies = [study_happyb2_prep, study_happyb2_0, study_happyb2_0_2025, study_bch]
